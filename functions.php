...
update_option( 'gt3_registration_supported_until', '12.12.2040' );
...
function gt3_activate_theme() {
	if ( current_user_can( 'manage_options' ) && !get_option( 'gt3_first_activation' ) ) {
		...
		// default elementor_cpt support
		$gt3_cpt_support = get_option( 'elementor_cpt_support' );
		if( ! $gt3_cpt_support ) {
			$gt3_cpt_support = [ 'page', 'post', 'portfolio' ];
			update_option( 'elementor_cpt_support', $gt3_cpt_support );
		} else if( ! in_array( 'portfolio', $gt3_cpt_support ) ) {
			$gt3_cpt_support[] = 'portfolio';
			update_option( 'elementor_cpt_support', $gt3_cpt_support );
		}
...
if (!function_exists('gt3_get_pf_type_output')) {
    function gt3_get_pf_type_output($pf, $width, $height, $featured_image, $cols = false){
        ...
        if (gt3_option('blog_post_fimage_animation')) {
	        $post_animate_start = '<div class="blog_post_media-animate">';
	        $post_animate_end = '</div>';
        }
...
/* WPDA Burger */
add_filter('wpda-builder/elementor/widgets', function($widgets) {
	$widgets[] = 'Burger_Sidebar';
	return $widgets;
});

add_filter( 'wpda_burger_sidebar_icon', function () {
	return '<i class="burger_sidebar_icon"><span class="first"></span><span class="second"></span><span class="third"></span></i>';
});

/* WPDA Walker */
add_filter( 'wpda_walker_menu', function () {
...
if (!function_exists('gt3_get_default_footer')) {
	function gt3_get_default_footer(){
		...
		echo '<footer class="main_footer fadeOnLoad clearfix gt3_default_footer" id="footer"><div class="copyright align-center"><div class="container"><div class="row"><div class="span12"><p>' . esc_html__('© 2020 — Ewebot by GT3Themes. All Rights Reserved.', 'ewebot') . '</p></div></div></div></div></footer>';
	}
}
